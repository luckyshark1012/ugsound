...
const MusicTable = () => {
    return (
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h1 className="text-center text-5xl mb-10">Music Lists</h1>
                    ...
                    <tbody>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src="https://t3.ftcdn.net/jpg/03/01/43/92/240_F_301439211_HEOKnBwIB2VyhxRzyCBDPzHtESNIL8YT.jpg" alt="Jese image" />
                                <div className="ps-3">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-green-500 me-2"></div> Open
                                </div>
                            </td>
                            <td className="px-6 py-4">
                                $8
                            ...
                            <td className="px-6 py-4">
                                <Link to='/' type="button" data-modal-target="editUserModal" data-modal-show="editUserModal" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">More Detail</Link>
                            </td>
                        </tr>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src="https://t3.ftcdn.net/jpg/05/52/05/14/240_F_552051439_UF8bU1klHYAkJplNv0QP3CeT71IraCj5.jpg" alt="Jese image" />
                                <div className="ps-3">
                            ...
                            <td className="px-6 py-4">
                                <Link to='/' type="button" data-modal-show="editUserModal" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">More Detail</Link>
                            </td>
                        </tr>
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src="https://t4.ftcdn.net/jpg/05/03/95/67/240_F_503956749_kYSeX9Ap5I9YI3wUF3H5QpEhh4ALdyT1.jpg" alt="Jese image" />
                                <div className="ps-3">
                        ...
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src="https://t4.ftcdn.net/jpg/04/75/70/21/240_F_475702184_izBt92dYyFtS0yZrlURtd6RwY3Ebpgr1.jpg" alt="Jese image" />
                                <div className="ps-3">
                        ...
                        <tr className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                <img className="w-10 h-10 rounded-full" src="https://t4.ftcdn.net/jpg/02/18/22/85/240_F_218228537_xvzNmTV0FSqNmLeJdjwCFneJL3r6cZoQ.jpg" alt="Jese image" />
                                <div className="ps-3">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center">
                                    <div className="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> Close
                                </div>
                            </td>
                            <td className="px-6 py-4" style={{textDecorationLine: 'line-through'}}>
                                $2
                            </td>
                            <td className="px-6 py-4">
                                <Link to='/' type="button" data-modal-show="editUserModal" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">More Detail</Link>
